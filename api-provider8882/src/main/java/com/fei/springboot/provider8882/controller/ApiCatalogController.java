...
import com.fei.springboot.provider8882.service.ApiCategoryService;
...
public class ApiCatalogController extends ApiBaseAction {
    ...
    public Object index(Integer id,
        ...
        //查询列表数据
        List<CategoryVo> data = this.categoryService.queryList(params);
        //
        CategoryVo currentCategory = null;
        if (null != id) {
            currentCategory = this.categoryService.queryObject(id);
        }
        ...
        if (null != currentCategory && null != currentCategory.getId()) {
            ...
            currentCategory.setSubCategoryList(this.categoryService.queryList(params));
        }
