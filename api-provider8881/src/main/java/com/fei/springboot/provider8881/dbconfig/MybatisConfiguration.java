package com.fei.springboot.provider8881.dbconfig;
...
@MapperScan(basePackages="com.fei.springboot.provider8882.dao")
public class MybatisConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactorys() throws Exception {
       ...
       //     sessionFactoryBean.setDataSource(roundRobinDataSouce);
            ...
            // 读取配置 
            sessionFactoryBean.setTypeAliasesPackage("com.fei.springboot.provider8882.domain");
