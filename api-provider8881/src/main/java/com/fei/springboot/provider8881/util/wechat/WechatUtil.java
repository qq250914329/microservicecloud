package com.fei.springboot.provider8881.util.wechat;

import com.alibaba.druid.support.logging.Log;
import com.alibaba.druid.support.logging.LogFactory;
import com.fei.springboot.util.CharUtil;
import com.fei.springboot.util.MapUtils;
import com.fei.springboot.util.ResourceUtil;
import com.fei.springboot.util.XmlUtil;
import com.fei.springboot.util.wechat.MD5;
...
public class WechatUtil {
    private static Log logger = LogFactory.getLog(com.fei.springboot.util.wechat.WechatUtil.class);
    /**
     * 充值客户端类型--微信公众号
     */
