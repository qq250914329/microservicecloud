...
import com.fei.springboot.service.FeignApiCommentService;
...
public class ApiCommentController extends ApiBaseAction {
    @Autowired
    private FeignApiCommentService commentService;
    ...
    public Object count(Integer typeId, Integer valueId) {
        return commentService.count(typeId,valueId);
    }
    ...
    public Object list(Integer typeId, Integer valueId, Integer showType,
        ...
        return commentService.list(typeId,valueId,showType,page,size,sort,order);
    }
}