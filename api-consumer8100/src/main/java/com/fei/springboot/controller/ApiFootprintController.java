...
import com.fei.springboot.service.FeignApiFootprintService;
...
public class ApiFootprintController extends ApiBaseAction {
    @Autowired
    private FeignApiFootprintService footprintService;
    ...
    public Object delete(@LoginUser UserVo loginUser, Integer footprintId) {
        return footprintService.delete(loginUser,footprintId);
    }
    ...
    public Object list(@LoginUser UserVo loginUser,
        ...
        return footprintService.list(loginUser,page,size);
    }
    ...
    public Object sharelist(@LoginUser UserVo loginUser,
                            @RequestParam(value = "page", defaultValue = "1") Integer page,
                            @RequestParam(value = "size", defaultValue = "10") Integer size) {
        return footprintService.sharelist(loginUser,page,size);
    }
}