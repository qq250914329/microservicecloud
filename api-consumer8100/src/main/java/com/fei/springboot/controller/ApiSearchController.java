...
import com.fei.springboot.service.FeignApiSearchService;
...
public class ApiSearchController extends ApiBaseAction {
    @Autowired
    private FeignApiSearchService searchService;
    ...
    public Object index(@LoginUser UserVo loginUser) {
        return searchService.index(loginUser);
    }
    ...
    public Object helper(@LoginUser UserVo loginUser, String keyword) {
        return searchService.helper(loginUser,keyword);
    }
    ...
    public Object clearhistory(@LoginUser UserVo loginUser) {
        return searchService.clearhistory(loginUser);
    }
}
