...
import com.fei.springboot.service.FeignApiCouponService;
...
public class ApiCouponController extends ApiBaseAction {
    @Autowired
    private FeignApiCouponService couponService;
    ...
    public Object list(@LoginUser UserVo loginUser) {
        return couponService.list(loginUser);
    }
    ...
    public Object listByGoods(@RequestParam(defaultValue = "cart") String type, @LoginUser UserVo loginUser) {
        return couponService.listByGoods(type,loginUser);
    }
