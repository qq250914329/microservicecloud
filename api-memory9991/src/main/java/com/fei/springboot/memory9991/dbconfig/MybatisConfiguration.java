package com.fei.springboot.memory9991.dbconfig;

import com.fei.springboot.memory9991.util.SpringContextUtil;
...
@MapperScan(basePackages="com.fei.springboot.memory9991.dao")
public class MybatisConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactorys() throws Exception {
       ...
       //     sessionFactoryBean.setDataSource(roundRobinDataSouce);
            ...
            // 读取配置 
            sessionFactoryBean.setTypeAliasesPackage("com.fei.springboot.memory9991.domain");
