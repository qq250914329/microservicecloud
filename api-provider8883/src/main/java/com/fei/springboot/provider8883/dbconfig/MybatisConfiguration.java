package com.fei.springboot.provider8883.dbconfig;
...
@MapperScan(basePackages="com.fei.springboot.provider8883.dao")
public class MybatisConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactorys() throws Exception {
       ...
       //     sessionFactoryBean.setDataSource(roundRobinDataSouce);
            ...
            // 读取配置 
            sessionFactoryBean.setTypeAliasesPackage("com.fei.springboot.provider8883.domain");
